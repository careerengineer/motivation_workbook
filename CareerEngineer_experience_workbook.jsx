...
const ExperienceWorkbook = () => {
  ...
  const handleSaveDoc = () => {
    ...
    experiences.forEach((e, i) => {
      ...
      if (e.jd_match) body += `<p><strong>직무상세내용 키워드 연결:</strong> ${e.jd_match}</p>`;
      body += `</div>`;
    });
  ...
  const handleSaveXlsx = () => {
    ...
    // [시트 3] 직무상세내용 매칭 (경험별 jd_match 메모 정리)
    if (experiences.some(e => e.jd_match)) {
      const jdRows = [
        ['경험별 직무상세내용 키워드 연결 메모'],
        [],
        ['No', '기관/활동명', '역할', '직무상세내용 매칭 메모'],
      ];
      experiences.forEach((e, i) => {
      ...
      XLSX.utils.book_append_sheet(wb, ws3, '직무상세내용매칭');
    }
    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: `${SPACING.xl}px ${SPACING.md}px` }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: SPACING.base, marginBottom: SPACING.xl }}>
        {[
          ...
          { n: '2', label: '직무상세내용 키워드 입력 (선택)', desc: '채용공고에서 뽑은 키워드 입력' },
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: `${SPACING.xl}px ${SPACING.md}px` }}>
        ...
        {detailStep === 4 && (
          <div>
            ...
            <div style={{ marginTop: SPACING.md }}>
              <Field label="이 경험이 커버하는 직무상세내용 키워드" hint="위 키워드 중 이 경험으로 뒷받침 가능한 것 + 구체적 연결 방식">
