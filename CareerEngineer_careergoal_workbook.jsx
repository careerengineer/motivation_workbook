...
const CareerAspirationWorkbook = () => {
  ...
  const downloadFinalText = () => {
    const h = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>입사 후 포부</title><style>body{font-family:'맑은 고딕',sans-serif;line-height:1.8;padding:40px}p{margin-bottom:1em}</style></head><body>${finalText.split('\n\n').map(x => `<p>${x.replace(/\n/g,'<br>')}</p>`).join('\n')}</body></html>`;
    ...
    <div style={{ ...S.page, padding: SPACING.xl }}>
      ...
      <div style={S.container}>
        ...
        <div style={S.cardLarge}>
          ...
          {/* ═══ 워크북 제목 ═══ */}
          <p style={S.brandEyebrow}>STEP 4 · 입사후 포부 작성</p>
          <h1 style={S.h1Center}>입사 후 포부</h1>
          <p style={{ ...S.subtitle, textAlign: 'center', marginBottom: SPACING.xl }}>3라운드 체계적 작성으로 완성하는 입사 후 포부</p>
          ...
          <RelatedWorkbookList
            ...
            items={[
              { id: 'job_analysis', hint: '회사 비전·사업 방향 (포부의 출처)' },
              { id: 'motivation', hint: '지원동기와 톤·방향 일치 (선행 또는 병행)' }
            ]}
          />
    ...
    <div style={S.page}>
      ...
      <div style={S.container}>
        ...
        <div style={S.cardLarge}>
              ...
              <div style={{ background: COLORS.bg, borderLeft: `3px solid ${COLORS.accent2}`, borderRadius: `0 ${RADIUS.sm}px ${RADIUS.sm}px 0`, padding: SPACING.base, marginBottom: SPACING.sm }}>
                ...
                {answers.connect_q1 && (
                  <div style={{ background: COLORS.blueBg, borderRadius: RADIUS.sm, padding: SPACING.sm, marginBottom: 6 }}>
                    ...
                    <p style={{ fontSize: FONT.size.xs, color: COLORS.accent, margin: 0, marginTop: 4, lineHeight: FONT.lineHeight.base }}>{answers.connect_q1.substring(0,150)}{answers.connect_q1.length>150?'...':''}</p>
                  </div>
                )}
              ...
              <div style={{ background: COLORS.bg, borderLeft: `3px solid ${COLORS.accent2}`, borderRadius: `0 ${RADIUS.sm}px ${RADIUS.sm}px 0`, padding: SPACING.base, marginBottom: SPACING.sm }}>
                ...
                {answers.connect_q2 && (
                  <div style={{ background: COLORS.blueBg, borderRadius: RADIUS.sm, padding: SPACING.sm, marginBottom: 6 }}>
                    ...
                    <p style={{ fontSize: FONT.size.xs, color: COLORS.accent, margin: 0, marginTop: 4, lineHeight: FONT.lineHeight.base }}>{answers.connect_q2.substring(0,150)}{answers.connect_q2.length>150?'...':''}</p>
                  </div>
                )}
              ...
              <div style={{ background: COLORS.bg, borderLeft: `3px solid ${COLORS.accent2}`, borderRadius: `0 ${RADIUS.sm}px ${RADIUS.sm}px 0`, padding: SPACING.base, marginBottom: SPACING.sm }}>
                ...
                {answers.connect_q3 && (
                  <div style={{ background: COLORS.blueBg, borderRadius: RADIUS.sm, padding: SPACING.sm, marginBottom: 6 }}>
                    ...
                    <p style={{ fontSize: FONT.size.xs, color: COLORS.accent, margin: 0, marginTop: 4, lineHeight: FONT.lineHeight.base }}>{answers.connect_q3.substring(0,150)}{answers.connect_q3.length>150?'...':''}</p>
                  </div>
                )}
              ...
              <div style={{ background: COLORS.bg, borderLeft: `3px solid ${COLORS.accent2}`, borderRadius: `0 ${RADIUS.sm}px ${RADIUS.sm}px 0`, padding: SPACING.base, marginBottom: SPACING.sm }}>
                ...
                {answers.connect_q4 && (
                  <div style={{ background: COLORS.blueBg, borderRadius: RADIUS.sm, padding: SPACING.sm, marginBottom: 6 }}>
                    ...
                    <p style={{ fontSize: FONT.size.xs, color: COLORS.accent, margin: 0, marginTop: 4, lineHeight: FONT.lineHeight.base }}>{answers.connect_q4.substring(0,150)}{answers.connect_q4.length>150?'...':''}</p>
                  </div>
                )}
          ...
          <RelatedWorkbookList
            items={[
              { id: 'job_analysis', hint: '회사 비전과 사업 방향 (포부의 출처)' },
              { id: 'motivation', hint: '지원동기와 톤·방향 일치' },
              { id: 'jobcompetency', hint: '직무역량 위에 그려질 미래 모습' },
              { id: 'interview_new', hint: '면접 마지막 질문과 직결' },
              { id: 'interview_career', hint: '면접 마지막 질문과 직결' }
            ]}
          />
          <div style={{ ...S.boxTip, marginBottom: SPACING.md }}>
            <p style={{ ...labelStyle(COLORS.yellow), marginBottom: SPACING.sm }}>멘토링 안내</p>
            <p style={{ fontSize: FONT.size.sm, color: COLORS.accent, margin: 0, lineHeight: FONT.lineHeight.base }}>
              포부가 "이상적 포부"에 그친다면 <a href="https://www.latpeed.com/products/fKnUV" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.accent2, fontWeight: FONT.weight.semibold, textDecoration: 'underline' }}>1:1 멘토링</a>으로 회사 방향성과의 연결을 점검받으세요
            </p>
          </div>
