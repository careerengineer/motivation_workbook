...
<div class="foot">
        ...
        <div style={{ background: '#fff', borderRadius: 14, padding: 32, border: '1px solid #6E7A8F33', marginBottom: 16 }}>
          ...
          <div style={{ background: '#F2F1EC', borderRadius: 12, padding: 20, marginBottom: 24, gap: 12 }}>
            ...
            <div style={{ gap: 8, fontSize: 16, color: '#1B3A6B' }}>
              {['기본 정보 입력', 'JD 키워드 추출', '경험 선별 및 우선순위 판단',
          ...
          <RelatedWorkbookList
            ...
            items={[
              { id: 'job_analysis', hint: 'JD 키워드 추출 — 이력서 핵심 성과 배치의 출발점' },
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 1:
        return (
          <div>
            <h2 style={{ fontSize: 20, fontWeight: 900, color: '#0E2750', marginBottom: 4 }}>PART 2: JD 키워드 추출</h2>
            <p style={{ fontSize: 16, color: '#6E7A8F', marginBottom: 24 }}>채용공고(JD)를 보면서 핵심 키워드를 뽑아주세요. 이 키워드가 이력서 전체의 뼈대가 됩니다.</p>
            ...
            <QuestionBlock
              id="jd_core"
              label="Q2-1. JD에서 추출한 핵심 업무 키워드 (3~5개)"
              hint="JD의 '주요업무' 항목에서 반복되는 핵심 단어를 그대로 뽑으세요"
              placeholder="예: 데이터 시각화, 고객 세그먼테이션, A/B 테스트, 전환 퍼널 분석"
              rows={2}
              guide={{
                description: 'JD의 "주요업무"에 나온 동사+명사 조합을 뽑습니다. "데이터를 활용한 마케팅 성과 분석"이면 키워드는 "데이터 분석", "마케팅 성과 분석"입니다.',
                helpQuestions: [
                  'JD에서 가장 먼저 나오는 업무 3개는 무엇인가요?',
            ...
            <QuestionBlock
              id="jd_tools"
              label="Q2-2. JD에서 요구하는 도구/기술/언어"
              hint="JD의 '자격요건' 또는 '필수역량'에 나온 도구명을 그대로 옮기세요"
              placeholder="예: Python, SQL, GA4, Tableau, BigQuery"
              rows={2}
              guide={{
                description: '도구명은 JD에 나온 그대로 적습니다. "Python"이라고 나왔으면 "파이썬"이 아니라 "Python"으로. ATS가 키워드를 스캔하기 때문입니다.',
      ...
      case 2:
        return (
          <div>
            ...
            <TipBox>
              경험의 우선순위 판단 기준: (1) JD 키워드와의 매칭도 (가장 중요) &gt; (2) 성과의 구체성 (수치가 있는가) &gt; (3) 최신성 (최근 경험이 유리). 이 세 가지 기준으로 경험을 정렬하세요.
            </TipBox>
                ...
                <QuestionBlock
                  ...
                  guide={{
                    ...
                    helpQuestions: [
                      ...
                      '어떤 도구/방법/기술을 사용했는가?',
                      'PART 2에서 뽑은 JD 키워드 중 이 경험과 연결되는 것은?'
                    ],
            ...
            <QuestionBlock
              ...
              hint="JD와 가장 매칭되는 이유를 간단히 적어주세요. 이 판단이 이력서 구조를 결정합니다."
              placeholder="예: JD에서 '데이터 분석'과 'Python'이 가장 먼저 나오고, 경험 1에서 Python 기반 분석을 직접 수행했으므로"
              rows={2}
            />
          ...
          <div>
            ...
            <div style={{ background: '#F2F1EC', border: '1px solid #1B3A6B33', color: '#0E2750', padding: 16, borderRadius: 10, marginBottom: 16 }}>
              ...
              <div style={{ gap: 8, fontSize: 16, color: '#0E2750' }}>
                <p><span style={{ fontWeight: 700 }}>1단계:</span> PART 2에서 뽑은 JD 핵심 키워드를 다시 보세요</p>
                <p><span style={{ fontWeight: 700 }}>2단계:</span> 내 경험 중 JD와 가장 매칭되는 키워드 3개를 뽑으세요</p>
            ...
            <QuestionBlock
              ...
              hint="JD 키워드와 매칭되는 것만 뽑으세요. JD에 없는 키워드는 의미가 없습니다."
              placeholder="예: 퍼포먼스 캠페인 운영, GA4 전환 분석, A/B 테스트"
              rows={2}
              guide={{
                description: 'PART 2의 JD 핵심 키워드를 왼쪽에, 내 경험 키워드를 오른쪽에 놓고 겹치는 것을 찾으세요. 겹치는 것이 없다면 내 경험을 JD 용어로 "번역"해야 합니다.',
                example: 'JD: 데이터 시각화 / 내 경험: Tableau로 매출 대시보드 구축 → 매칭됨\nJD: 고객 분석 / 내 경험: 설문조사 결과 정리 → 부분 매칭 (약한 연결)\nJD: A/B 테스트 / 내 경험: 없음 → 매칭 안 됨 (한줄 소개에서 제외)'
              }}
            />
            ...
            <QuestionBlock
              ...
              hint="불필요한 수식어 빼기, JD 키워드 우선 배치, 읽어서 7초 안에 '이 사람이 뭘 할 수 있는지' 파악되는지 확인"
        ...
        return (
          <div>
            ...
            <QuestionBlock
              id="skills"
              label="직무 관련 자격증 & 스킬"
              hint="JD에 나온 도구/자격증 중 내가 가진 것만. 직무 연관도 높은 순서로 배치."
              placeholder={"예:\n자격증: 품질경영기사, SQLD, 6시그마 GB\n스킬: Python | SQL | Tableau | GA4 | CATIA V5\n\n(IT 직무) 기술 스택: Java | Spring Boot | MySQL | AWS EC2 | Docker | Git"}
              rows={4}
              guide={{
                description: '직무와 무관한 자격증(운전면허, 한자능력검정 등)은 절대 넣지 마세요. 기초 수준의 범용 도구(한글, 파워포인트)도 넣지 마세요. JD에 명시된 것만 넣으세요.',
      ...
      case 6:
        const checkItems = [
          ...
          { id: 'c4', text: 'JD 키워드가 이력서에 자연스럽게 들어가 있는가?', action: 'PART 2의 키워드와 대조' },
      ...
      case 7:
        ...
        <RelatedWorkbookList
          items={[
            { id: 'job_analysis', hint: 'JD 키워드를 더 정교하게 추출' },
            { id: 'experience', hint: '핵심 성과의 출처 (경험 인벤토리)' },
  ...
  // ==================== MAIN LAYOUT ====================
  const stepTitles = ['기본 정보', 'JD 키워드', '경험 선별', '한줄 소개', '경력 정리', '프로젝트/스킬', '최종 점검', '완성'];
  ...
  const savePartial = () => {
    ...
    const labels = {
      ...
      jd_core: 'JD 핵심 키워드', jd_tools: 'JD 도구/기술', jd_nice: 'JD 우대사항',
    ...
    const partGroups = [
      ...
      { title: 'PART 2. JD 키워드 추출', keys: ['jd_core', 'jd_tools', 'jd_nice'] },
